...
const AboutHero = () => {
  return (
    <section className="relative h-auto min-h-[100svh] lg:min-h-[50vh] pt-32 pb-20 lg:pt-28 lg:pb-16 flex flex-col justify-center overflow-hidden bg-nand-navy">
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 mt-8">
        {/* Breadcrumb */}
        <div className="flex items-center justify-center md:justify-start space-x-2 text-sm text-gray-300 mb-5 font-medium w-full">
