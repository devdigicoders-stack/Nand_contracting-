...
const FinalCTA = () => {
  return (
    <section className="py-16 md:py-24 bg-nand-light border-b border-gray-200">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-8">
          <Link 
            to="/contact" 
            className="flex-1 sm:flex-none inline-flex items-center justify-center px-8 py-3 md:px-10 md:py-3.5 text-sm md:text-base bg-nand-orange text-white text-base font-medium rounded-md hover:bg-[#e66d00] transition-colors shadow-sm group"
          >
            Request a Quote
          ...
          <Link 
            to="/contact" 
            className="flex-1 sm:flex-none inline-flex items-center justify-center px-8 py-3 md:px-10 md:py-3.5 text-sm md:text-base bg-white border border-gray-200 text-nand-navy text-base font-bold rounded-md hover:bg-gray-50 hover:border-gray-300 transition-colors shadow-sm"
          >
