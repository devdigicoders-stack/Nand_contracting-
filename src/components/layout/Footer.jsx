...
const Footer = () => {
  ...
  return (
    <footer className="bg-nand-navy text-slate-300 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-8 sm:py-10 lg:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-4 flex flex-col items-start text-left pb-6 lg:pb-0">
            <Link to="/" className="inline-block mb-5 hover:opacity-90 transition-opacity">
              <img src="/footer_logo.png" alt="NAND Contracting & Hospitality Services" className="h-14 sm:h-16 w-auto object-contain" />
            </Link>
          ...
          <div className="lg:col-span-2 flex flex-col items-start text-left">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm">
              ...
              <li><Link to="/projects" className="text-slate-400 hover:text-nand-orange transition-colors hover:translate-x-0.5 inline-block">Projects & Gallery</Link></li>
          ...
          <div className="lg:col-span-3 flex flex-col items-start text-left">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm">
              <li><Link to="/contracting" className="text-slate-400 hover:text-nand-orange transition-colors hover:translate-x-0.5 inline-block">Contracting & Civil Works</Link></li>
              <li><Link to="/contracting" className="text-slate-400 hover:text-nand-orange transition-colors hover:translate-x-0.5 inline-block">Facility & Building Maintenance</Link></li>
              <li><Link to="/contracting" className="text-slate-400 hover:text-nand-orange transition-colors hover:translate-x-0.5 inline-block">Technical MEP Maintenance</Link></li>
              <li><Link to="/renovation-fitout" className="text-slate-400 hover:text-nand-orange transition-colors hover:translate-x-0.5 inline-block">Renovation & Interior Fit-Out</Link></li>
              <li><Link to="/manpower-hospitality" className="text-slate-400 hover:text-nand-orange transition-colors hover:translate-x-0.5 inline-block">Manpower & Hospitality Outsourcing</Link></li>
            </ul>
          </div>
